...
const UI: Dict = {
  ...
  "panel.merchants": { it: "Esercenti", en: "Merchants" },
  "panel.merchants.hint": {
    it: "Dove vanno davvero i soldi — clicca per esplorare",
    en: "Where the money actually goes — click to drill",
  },
  "panel.merchants.more": { it: "e altri {n} esercenti", en: "and {n} more merchants" },
  "tx.clearMerchant": { it: "Rimuovi il filtro esercente", en: "Clear the merchant filter" },
  "det.merchant": { it: "Esercente", en: "Merchant" },
  "det.purchaseTime": { it: "Ora", en: "Time" },
  ...
  "inv.flow": { it: "Netto investito per mese", en: "Net invested per month" },
  "inv.flow.series": { it: "Netto investito", en: "Net invested" },
  "inv.flow.cum": { it: "Netto investito nel tempo", en: "Net invested over time" },
  "inv.flow.cum.hint": { it: "cumulato · versato − rientrato finora", en: "cumulative · contributed − returned so far" },
  "inv.cumulative": { it: "Cumulato", en: "Cumulative" },
  "inv.flow.hint": { it: "mensile · versato − rientrato", en: "monthly · contributed − returned" },
  ...
  "mng.health": { it: "Salute dati", en: "Data health" },
  "mng.health.hint": { it: "I movimenti importati tornano con i saldi dichiarati dagli estratti?", en: "Do the imported movements add up to the balances the statements declare?" },
  "mng.health.ok": { it: "Tutto riconciliato: {n} intervalli verificati al centesimo.", en: "Fully reconciled: {n} intervals verified to the cent." },
  "mng.health.bad": { it: "{bad} intervalli su {n} non tornano.", en: "{bad} of {n} intervals do not add up." },
  "mng.health.none": { it: "Nessun saldo dichiarato in archivio: carica un estratto (o esegui \"Riprocessa\") per attivare la verifica.", en: "No statement-declared balances yet: upload a statement (or run \"Reprocess\") to enable the check." },
  "mng.health.account": { it: "Conto", en: "Account" },
  "mng.health.intervals": { it: "Intervalli", en: "Intervals" },
  "mng.health.mismatched": { it: "Non riconciliati", en: "Mismatched" },
  "mng.health.netDisc": { it: "Differenza netta", en: "Net difference" },
  "mng.health.lastBalance": { it: "Ultimo saldo dichiarato", en: "Last declared balance" },
  "mng.health.period": { it: "Periodo", en: "Period" },
  "mng.health.expected": { it: "Atteso", en: "Expected" },
  "mng.health.actual": { it: "Importato", en: "Imported" },
  "mng.health.diff": { it: "Differenza", en: "Difference" },
  "mng.health.more": { it: "… e altri {n}", en: "… and {n} more" },
  "mng.health.boundaryNote": { it: "Su Intesa una differenza che si specchia su due trimestri adiacenti è quasi sempre una valuta a cavallo del confine (il saldo dell'estratto segue la data contabile, la verifica la data valuta), non un dato perso.", en: "On Intesa, a difference mirrored across two adjacent quarters is almost always a value date crossing the boundary (the statement balance follows the booking date, the check follows the value date), not lost data." },
